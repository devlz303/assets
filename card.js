...
async function init() {
  ...
  createCardLayer('front', `${cardColor} transparent`, `
    <div>
  ...
  // backside - traits
  createCardLayer('back', `${cardColor} transparent`, `
...
function updateGradient() {
  ...
  cssStyleRules['.card.overlay'].style.background = `linear-gradient(90deg, rgba(134,134,134,1) 0%, rgba(242,242,242,1) ${pos1}%, rgba(242,242,242,1) ${pos2}%, rgba(134,134,134,1) 100%)`;
}

function createCardLayer(side = 'front', className = '', innerHTML = '', zIndex = 0) {
