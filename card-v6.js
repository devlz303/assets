/*
        TODO:
        - remove baseUrl
        - remove collectionUrl and use /content/<inscriptionid> 
        - remove tempBaseUrl
        - get cardColor from json
      */
      ...
      let camera, scene, renderer, controls, styleRules, cardColor;

      async function init() {
        if (typeof THREE !== 'object' || document.readyState !== 'complete') return setTimeout(async () => await init(), 10);
